...
The first pass is architecture-focused. It collects classes, structs, records, interfaces, enums, methods, and invocation targets so `llmcc-format` can produce useful project maps for agents.
