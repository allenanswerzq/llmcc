...
The first pass is architecture-focused. It collects classes, functions/methods, and call targets so `llmcc-format` can produce useful project maps for agents.
