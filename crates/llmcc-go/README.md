...
The first pass is architecture-focused. It collects type specs, functions/methods, and call targets so `llmcc-format` can produce useful project maps for agents.
