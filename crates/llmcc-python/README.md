...
The first pass is architecture-focused. It collects modules, classes, functions/methods, and call targets so `llmcc-format` can produce useful project maps for agents.
