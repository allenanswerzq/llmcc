...
def build_graph_context(graph: Optional[str] = None) -> Optional[str]:
    ...
    return f"""## llmcc Architecture Graph

You have access to an architecture graph generated by llmcc, a tool that extracts
high-level code structure from a codebase. This graph shows modules, key functions,
types, and their relationships.

Use this graph to understand the codebase structure and navigate directly to relevant
code instead of searching blindly.
